...
if($page == 1)
{
	...
	{
		$nextpage = $page + 1;
		echo("<div class=\"nextpage\"><a href=\"http://jejunubus.hosting.paran.com/jejunubus1.0/board.php?page=". $nextpage ."\">". ">" ."</a></div>");
	}
}
...
{
	$backpage = $page -1;
	echo("<div class=\"backpage\"><a href=\"http://jejunubus.hosting.paran.com/jejunubus1.0/board.php?page=". $backpage ."\">". "<" ."</a></div>");
}
